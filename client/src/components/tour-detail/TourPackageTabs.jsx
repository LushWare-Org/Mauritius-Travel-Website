...
const TourPackageTabs = ({ pkg }) => {
    ...
    const inclusions = pkg.included && pkg.included.length > 0 ? pkg.included : [
    ...
    const exclusions = pkg.notIncluded && pkg.notIncluded.length > 0 ? pkg.notIncluded : [
    ...
    return (
        <div className="bg-white rounded-lg shadow-md overflow-hidden mt-6">
            ...
            <div className="flex border-b overflow-x-auto">
                <button
                    className={`px-4 py-3 text-sm font-medium whitespace-nowrap ${activeTab === 'description' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-blue-500'}`}
                ...
                <button
                    className={`px-4 py-3 text-sm font-medium whitespace-nowrap ${activeTab === 'exclusions' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-blue-500'}`}
            ...
            <div className="p-6">
                {activeTab === 'description' && (
                    <div className="space-y-4">
                        <h3 className="text-xl font-semibold text-gray-800">About This Tour</h3>
                ...
                {activeTab === 'itinerary' && pkg.itinerary && pkg.itinerary.length > 0 && (
                    <div className="space-y-4">
                        <h3 className="text-xl font-semibold text-gray-800">Tour Itinerary</h3>
                        <div className="space-y-4">
                ...
                {activeTab === 'reviews' && (
                    <div className="space-y-8">
                        ...
                        {/* Feedback List */}
                        <div>
                            <h4 className="text-lg font-semibold mb-4">Customer Reviews ({feedbacks.length})</h4>
                            ...
                            {loading ? (
                                ...
                                <div className="space-y-6">
                                    {feedbacks.map((feedback) => (
                                        <div key={feedback._id} className="border-b pb-6 last:border-0 last:pb-0">
