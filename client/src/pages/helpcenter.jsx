      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="#faqs"
              className="bg-green-50 text-green-700 px-4 py-2 rounded-lg hover:bg-green-100 transition"
            >
              FAQs
            </a>
            <Link
              to="/contact"
              className="bg-purple-50 text-purple-700 px-4 py-2 rounded-lg hover:bg-purple-100 transition"
            >
              Contact Support
            </Link>
            <Link
              to="/dashboard/bookings"
              className="bg-orange-50 text-orange-700 px-4 py-2 rounded-lg hover:bg-orange-100 transition"
            >
              My Bookings
            </Link>
          </div>
        ...
        <div
          id="getting-started"
          className="mb-12 bg-white rounded-xl shadow-md p-6 md:p-8"
        >
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="bg-blue-100 text-blue-800 text-sm font-semibold w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      1
                    </span>
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Choose a excursion </span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-blue-100 text-blue-800 text-sm font-semibold w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      3
                    ...
                    <span className="text-gray-700">
                      Add any extras (like airport transfer)
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-blue-100 text-blue-800 text-sm font-semibold w-6 h-6 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
              ...
              <div className="p-5">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700">
                      Yes, you can add airport transfer services during the
                      booking process. Simply select the "Add Airport Transfer"
                      option when making your reservation.
                    </p>
                  </div>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 mb-3">
                      Yes, depending on the plan you choose. Flexible bookings
                      allow free cancellation before the deadline specified in
                    ...
                    <div className="bg-yellow-50 rounded-lg p-4">
                      ...
                      <ul className="space-y-1 text-sm text-gray-700">
                        <li className="flex items-center">
                          ...
                          <span>Call us at +230 5813 7644</span>
                        </li>
                        <li className="flex items-center">
                          <i className="fas fa-check text-green-500 mr-2"></i>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        <div className="flex items-center mb-3">
                          <span className="bg-purple-100 text-purple-800 text-sm font-semibold w-6 h-6 rounded-full flex items-center justify-center mr-3">
                            1
                          </span>
                          <span className="text-gray-700">
                            Go to your Profile
