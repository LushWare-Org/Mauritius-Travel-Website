  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        if (!token) {
          console.error(
            'No authentication token found when trying to fetch dashboard data'
          );
        } else {
        ...
        if (response.data.success) {
          ...
          console.error(
            'API returned success:false when fetching dashboard data'
          );
        ...
        if (retryCount < 3) {
          console.log(
            `Retrying dashboard data fetch (attempt ${retryCount + 1} of 3)...`
          );
          setTimeout(() => {
      ...
      <div>
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Here's an overview of your bookings and excursions.
          </p>
        </div>{' '}
        {/* Error Message */}
        {error && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                ...
                <Link
                  ...
                  className="text-blue-600 text-sm flex items-center mt-4 hover:underline"
                >
                  View pending{' '}
              ...
              <div className="bg-green-50 p-6 rounded-lg border border-green-100">
                ...
                <Link
                  to="/dashboard/bookings"
                  className="text-green-600 text-sm flex items-center mt-4 hover:underline"
                >
                  View confirmed{' '}
                  <i className="fas fa-arrow-right ml-1 text-xs"></i>
                </Link>
              ...
              <div className="bg-purple-50 p-6 rounded-lg border border-purple-100">
                ...
                <Link
                  ...
                  className="text-purple-600 text-sm flex items-center mt-4 hover:underline"
                >
                  View history{' '}
                  <i className="fas fa-arrow-right ml-1 text-xs"></i>
                </Link>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                >
                  <div className="flex items-center">
                    <div className="bg-purple-100 p-3 rounded-full">
                      <i className="fas fa-suitcase-rolling text-purple-500"></i>
                    </div>
                    <div className="ml-4">
                      <h4 className="text-gray-800 font-medium">
